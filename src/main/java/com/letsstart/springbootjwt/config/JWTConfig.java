package com.letsstart.springbootjwt.config;
...
public class JWTConfig extends AuthorizationServerConfigurerAdapter{
	...
	@Value("${fahri.oauth.tokenTimeout:3600}")
	...
	public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
		...
		clients.inMemory().withClient("fahri").secret("secret").accessTokenValiditySeconds(expiration)
